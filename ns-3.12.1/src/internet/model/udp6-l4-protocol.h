...
/**
 * \ingroup udp6
 * \brief Implementation of the UDPv6 protocol
 */
...
public:
  ...
  /**
   * \return A smart Socket pointer to a Udp6Socket, allocated by this instance
   * of the UDPv6 protocol
   */
